...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.MyViewHolder> {
    ...
    final private HistoryAdapter.ListItemClickListener mOnClickListener;

    public HistoryAdapter(Context ct, ArrayList<Pertandingan> listRecyclerItem, HistoryAdapter.ListItemClickListener mOnClickListener) {
        context =ct;
